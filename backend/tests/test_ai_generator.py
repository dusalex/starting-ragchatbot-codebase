...
class TestAIGenerator:
    ...
    def test_single_round_no_tools(self, ai_generator, mock_client):
        ...
        mock_response = MockResponse([
            {"type": "text", "text": "Direct response without tools"}
        ], "end_turn")
    ...
    def test_single_round_with_tools_direct_response(self, ai_generator, mock_client, 
    ...
    def test_two_round_sequential_tool_calling(self, ai_generator, mock_client, 
                                             mock_tool_manager, sample_tools):
    ...
    def test_tool_execution_error_handling(self, ai_generator, mock_client, 
                                         mock_tool_manager, sample_tools):
    ...
    def test_max_rounds_termination(self, ai_generator, mock_client, 
                                   mock_tool_manager, sample_tools):
    ...
    def test_conversation_history_integration(self, ai_generator, mock_client):
        ...
        mock_response = MockResponse([
            {"type": "text", "text": "Response considering history"}
        ], "end_turn")
    ...
    def test_build_system_content_multi_round_instructions(self, ai_generator):
        ...
        assert "You can make up to 2 tool calls across separate rounds" in system_content
