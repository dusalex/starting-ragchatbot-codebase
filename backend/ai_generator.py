...
"""
    ...
    def _execute_conversation_round(self, messages: List[Dict], 
                                   system_content: str,
                                   tools: Optional[List] = None,
                                   tool_manager=None) -> Tuple[Any, bool]:
        """
    ...
    def _should_continue_rounds(self, response, current_round: int, max_rounds: int) -> bool:
        """
        ...
        has_text = any(block.type == "text" and block.text.strip() 
